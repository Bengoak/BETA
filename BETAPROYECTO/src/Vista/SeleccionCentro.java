...
public class SeleccionCentro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lCentros = new javax.swing.JList();
        ...
        lCentros.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        jScrollPane1.setViewportView(lCentros);

        bSeleccion.setText("Selección");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeleccionCentro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionCentro().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList lCentros;
